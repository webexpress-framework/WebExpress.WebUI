...
webexpress.webui.I18N.register("en", "webexpress.webui", {
    ...
    "dnf.and": "and",
    "dnf.or": "or",
    "dnf.add": "Add expression",
    "dnf.remove": "Remove expression",
    "dnf.clear": "Clear expression",

    "quickfilter.add": "Add filter",
    "quickfilter.edit": "Edit filter",
    "quickfilter.options": "Filter options",
    "quickfilter.remove.title": "Remove filter",
    "quickfilter.remove.message": "Remove this filter?",
    ...
    "editor.image.width": "Width",
    "editor.image.height": "Height",
    "editor.image.size": "Image size",
    "editor.image.size.original": "Original size",
    "editor.image.size.placeholder": "Automatic, 320px or 50%",
    "editor.image.error.size": "Enter a positive size in pixels or percent, or leave the field empty.",
    "editor.image.align.left": "Align image left",
    "editor.image.align.center": "Center image",
    "editor.image.align.right": "Align image right",
    "editor.image.align.inline": "Image in text flow",
