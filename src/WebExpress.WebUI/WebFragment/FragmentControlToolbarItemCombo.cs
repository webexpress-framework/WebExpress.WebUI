...
{
    /// <summary>
    /// Represents a toolbar combo control fragment that can be processed and rendered within a web page.
    /// </summary>
    public abstract class FragmentControlToolbarItemCombo : ControlToolbarItemCombo, IFragmentWebUIElement<IRenderControlContext, IVisualTreeControl>, IFragmentControlToolbarItem
    {
        ...
        protected FragmentControlToolbarItemCombo(IFragmentContext fragmentContext)
