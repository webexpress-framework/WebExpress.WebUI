...
namespace WebExpress.WebUI.WebFragment
{
    ...
    /// </summary>
    public class FragmentControlSidebarItemControl : ControlSidebarItemControl, IFragmentWebUIElement<IRenderControlContext, IVisualTreeControl>, IFragmentControlSidebarItem
    {
        /// <summary>
