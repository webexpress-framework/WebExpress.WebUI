...
namespace WebExpress.WebUI.WebControl
{
    ...
    public class ControlFormEventFormValidate : ControlFormEvent
    {
        ...
        /// <param name="type">The type of the validation result. Defaults to <see cref="TypesInputValidity.Error"/>.</param>
        /// <returns>The current instance for method chaining.</returns>
        public ControlFormEventFormValidate Add(bool predicate, string text, TypesInputValidity type = TypesInputValidity.Error)
        {
            if (predicate)
            {
