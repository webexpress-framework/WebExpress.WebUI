...
namespace WebExpress.WebUI.WebControl
{
    ...
    public class ControlFormItemInputTile : ControlFormItemInput<ControlFormInputValueStringList>, IControlFormItemInputTile
    {
        ...
        public ControlFormItemInputTile([CallerMemberName] string instance = null, [CallerFilePath] string file = null, [CallerLineNumber] int? line = null)
            : this($"tile_{instance}_{file}_{line}".GetHashCode().ToString("X"))
        {
        }
