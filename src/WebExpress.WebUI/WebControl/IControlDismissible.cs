...
namespace WebExpress.WebUI.WebControl
{
    ...
    /// list/tile selection).
    /// </summary>
    public interface IControlDismissible : IControl
    {
        /// <summary>
        ...
        IControlDismissible Add(params IControl[] controls);
        ...
        /// <param name="controls">The controls to add.</param>
        /// <returns>The current instance for method chaining.</returns>
        IControlDismissible Add(IEnumerable<IControl> controls);
        ...
        /// <returns>The current instance for method chaining.</returns>
        IControlDismissible Remove(IControl control);
    }
}
