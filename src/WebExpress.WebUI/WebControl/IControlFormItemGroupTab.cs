...
namespace WebExpress.WebUI.WebControl
{
    ...
    public interface IControlFormItemGroupTab : IControlFormItemGroup
    {
        ...
        IControlFormItemGroupTab Add(params IControlFormItemGroupTabView[] views);
        ...
        /// <param name="views">The tab views to add. Cannot be null.</param>
        /// <returns>The current instance of the group, enabling method chaining.</returns>
        IControlFormItemGroupTab Add(IEnumerable<IControlFormItemGroupTabView> views);
        ...
        IControlFormItemGroupTab Remove(IControlFormItemGroupTabView view);
    }
}
