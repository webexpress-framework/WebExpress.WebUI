...
namespace WebExpress.WebUI.WebControl
{
    ...
    /// </summary>
    public class ControlSplit : Control, IControlSplit
    {
        private readonly List<IControl> _sidePanel = [];
        private readonly List<IControl> _mainPanel = [];

        /// <summary>
        /// Returns the left or top panel in the ControlSplit.
        /// </summary>
        public IEnumerable<IControl> SidePanel => _sidePanel;

        /// <summary>
        /// Returns the right or bottom pane in the ControlSplit.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the minimum size of the left or top area in the ControlSplit.
        /// </summary>
        public Func<IRenderControlContext, int> SidePanelMinSize { get; set; } = _ => -1;

        /// <summary>
        /// Gets or sets the initial size of the left or top area in the ControlSplit in %.
        /// </summary>
        public Func<IRenderControlContext, int> SidePanelInitialSize { get; set; } = _ => -1;

        /// <summary>
        /// Gets or sets the maximum size of the left or top area in the ControlSplit.
        /// </summary>
        ...
        public ControlSplit(string id = null)
            : base(id)
        {
        }
        ...
        public ControlSplit(string id, IControl[] sidePanel, IControl[] mainPanel)
            : base(id)
        {
        ...
        public IControlSplit AddSidePanel(params IControl[] controls)
        {
        ...
        /// <returns>The current instance for method chaining.</returns>
        public IControlSplit RemoveSidePanel(IControl control)
        {
        ...
        /// <param name="controls">The controls to add.</param>
        /// <returns>The current instance for method chaining.</returns>
        public IControlSplit AddMainPanel(params IControl[] controls)
        {
        ...
        /// <param name="control">The control to remove.</param>
        /// <returns>The current instance for method chaining.</returns>
        public IControlSplit RemoveMainPanel(IControl control)
        {
