...
{
    /// <summary>
    /// Represents a property color for graph control that can be converted to CSS classes or styles.
    /// </summary>
    public class PropertyColorGraph : PropertyColor<TypeColorGraph>
    {
        /// <summary>
        /// Initializes a new instance of the class with a specified system color.
        /// </summary>
        /// <param name="color">The system color.</param>
        public PropertyColorGraph(TypeColorGraph color)
        {
            SystemColor = color;
        }
        ...
        public PropertyColorGraph(string color)
        {
            SystemColor = (TypeColorGraph)TypeColor.User;
            UserColor = color;
        }
