...
{
    /// <summary>
    /// Represents a control that renders a text in a table using a template.
    /// </summary>
    public class ControlTableTemplateText : IControlTableTemplateEditable
    {
        /// <summary>
        ...
        /// <summary>
        /// Returns or sets the color associated with this property text.
        /// </summary>
        ...
        public ControlTableTemplateText(string id = null)
        {
            Id = id;
        }
