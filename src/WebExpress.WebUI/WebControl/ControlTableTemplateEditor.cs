...
{
    /// <summary>
    /// Represents a control that renders a editor in a table using a template.
    /// </summary>
    public class ControlTableTemplateEditor : IControlTableTemplateEditable
    {
        /// <summary>
        ...
        public ControlTableTemplateEditor(string id = null)
        {
            Id = id;
        }
