...
namespace WebExpress.WebUI.WebControl
{
    ...
    /// </summary>
    public class ControlMain : ControlPanel
    {
        /// <summary>
        ...
        public ControlMain(string id = null, params IControl[] content)
            : base(id, content)
        {
        }
        ...
        public override IHtmlNode Render(IRenderControlContext renderContext, IVisualTreeControl visualTree)
        {
            ...
            var html = new HtmlElementSectionMain([.. Content.Select(x => x.Render(renderContext, visualTree))])
            {
                Id = Id,
