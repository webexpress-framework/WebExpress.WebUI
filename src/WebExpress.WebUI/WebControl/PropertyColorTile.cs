namespace WebExpress.WebUI.WebControl
{
    ...
    public class PropertyColorTile : PropertyColor<TypeColorTile>
    {
        ...
        public PropertyColorTile(string color)
        {
            SystemColor = (TypeColorTile)TypeColor.User;
            UserColor = color;
        }
