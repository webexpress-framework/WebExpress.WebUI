...
namespace WebExpress.WebUI.Test.WebFragment
{
    ...
    public class UnitTestFragmentManager
    {
        ...
        [InlineData(typeof(TestApplication), typeof(TestSectionFragmentControlForm), typeof(IScope), @"<form id=""form_webexpress-webui-test-testfragmentcontrolform"" action=""http://localhost:8080/"" method=""POST"" enctype=""multipart/form-data"">*</form>")]
        [InlineData(typeof(TestApplication), typeof(TestSectionFragmentControlModalForm), typeof(IScope), @"<form id=""form_webexpress-webui-test-testfragmentcontrolmodalform"" *>*<div id=""webexpress-webui-test-testfragmentcontrolmodalform"" class=""wx-webui-modal"" role=""dialog"" data-close-label=""Close"">*</form>")]
