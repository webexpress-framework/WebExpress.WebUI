...
namespace WebExpress.WebUI.Test.WebFragment
{
    ...
    public class UnitTestFragmentManager
    {
        ...
        [InlineData(typeof(TestApplication), typeof(TestSectionFragmentControlDropdownItemLink), typeof(IScope), @"<div id=""webexpress.webui.test.testfragmentcontroldropdownitemlink"" class=""wx-dropdownbutton-item"">TestFragmentControlDropdownItemLink</div>")]
        ...
        [InlineData(typeof(TestApplication), typeof(TestSectionFragmentControlPanelTool), typeof(IScope), @"<div id=""webexpress-webui-test-testfragmentcontrolpaneltool"" class=""toolpanel border""><div class=""wx-webui-dropdownbutton"" role=""button""></div><div><div>TestFragmentControlPanelTool</div></div></div>")]
        ...
        [InlineData(typeof(TestApplication), typeof(TestSectionFragmentControlToolbarItemButton), typeof(IScope), @"<a id=""webexpress-webui-test-testfragmentcontroltoolbaritembutton"" class=""link nav-link"">TestFragmentControlToolbarItemButton</a>")]
