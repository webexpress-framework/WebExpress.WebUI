...
namespace WebExpress.WebUI.Test.WebControl
{
    ...
    public class UnitTestControlMain
    {
        /// <summary>
        ...
        public void Id(string id, string expected)
        {
            ...
            var control = new ControlMain(id)
            {
            };
        ...
        [InlineData(TypeTheme.Light, @"<main data-wx-theme=""light""></main>")]
        [InlineData(TypeTheme.Dark, @"<main data-wx-theme=""dark""></main>")]
        ...
        [InlineData(typeof(ControlImage), @"<main><img alt></main>")]
