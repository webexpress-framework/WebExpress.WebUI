...
{
    /// <summary>
    /// Tests the <see cref="ControlDismissible"/> control.
    /// </summary>
    [Collection("NonParallelTests")]
    public class UnitTestControlDismissible
    {
        /// <summary>
        ...
        public void Id(string id, string expected)
        {
            ...
            var control = new ControlDismissible(id);
        ...
        public void TitleIsEmittedAsDataAttribute()
        {
            ...
            var context = UnitTestControlFixture.CreateRenderContextMock();
            var visualTree = new VisualTreeControl(componentHub, context.PageContext);
            var control = new ControlDismissible("p")
            {
                Title = _ => "Details"
            };
        ...
        public void RemoveDropsControl()
        {
            ...
            var control = new ControlDismissible("p").Add(text);
