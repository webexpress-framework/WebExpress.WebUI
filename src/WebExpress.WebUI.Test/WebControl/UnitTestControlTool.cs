...
namespace WebExpress.WebUI.Test.WebControl
{
    ...
    public class UnitTestControlTool
    {
        /// <summary>
        ...
        public void Id(string id, string expected)
        {
            ...
            var control = new ControlTool(id)
            {
            };
        ...
        public void Tools(string text, string expected)
        {
            ...
            var context = UnitTestControlFixture.CreateRenderContextMock();
            var visualTree = new VisualTreeControl(componentHub, context.PageContext);
            var childInstance = new ControlDropdownItemLink() { Text = _ => text };
            var control = new ControlTool()
            {
            };
        ...
        [InlineData(TypeTheme.Light, @"<div class=""toolpanel border"" data-wx-theme=""light"">*</div>")]
        [InlineData(TypeTheme.Dark, @"<div class=""toolpanel border"" data-wx-theme=""dark"">*</div>")]
