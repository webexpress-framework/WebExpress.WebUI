...
namespace WebExpress.WebUI.Test.WebControl
{
    ...
    public class UnitTestControlPanelTool
    {
        ...
        /// </summary>
        [Theory]
        [InlineData(null, @"<div class=""toolpanel border""><div class=""wx-webui-dropdownbutton"" role=""button""></div><div></div></div>")]
        [InlineData("id", @"<div id=""id"" class=""toolpanel border""><div class=""wx-webui-dropdownbutton"" role=""button""></div><div></div></div>")]
        ...
        /// </summary>
        [Theory]
        [InlineData(TypeDirection.Default, @"<div class=""toolpanel border""><div class=""wx-webui-dropdownbutton"" role=""button""></div><div></div></div>")]
        ...
        /// </summary>
        [Theory]
        [InlineData(TypePanelContainer.None, @"<div class=""toolpanel border""><div class=""wx-webui-dropdownbutton"" role=""button""></div><div></div></div>")]
        ...
        /// </summary>
        [Theory]
        [InlineData(null, @"<div class=""toolpanel border""><div class=""wx-webui-dropdownbutton"" role=""button""><div class=""wx-dropdownbutton-item""></div></div><div></div></div>")]
        [InlineData("abc", @"<div class=""toolpanel border""><div class=""wx-webui-dropdownbutton"" role=""button""><div class=""wx-dropdownbutton-item"">abc</div></div><div></div></div>")]
        [InlineData("webexpress.webui:plugin.name", @"<div class=""toolpanel border""><div class=""wx-webui-dropdownbutton"" role=""button""><div class=""wx-dropdownbutton-item"">webexpress.webui:plugin.name</div></div><div></div></div>")]
        ...
        /// </summary>
        [Theory]
        [InlineData(typeof(ControlText), @"<div class=""toolpanel border""><div class=""wx-webui-dropdownbutton"" role=""button""></div><div><div></div></div></div>")]
        [InlineData(typeof(ControlLink), @"<div class=""toolpanel border""><div class=""wx-webui-dropdownbutton"" role=""button""></div><div><a class=""link""></a></div></div>")]
        [InlineData(typeof(ControlImage), @"<div class=""toolpanel border""><div class=""wx-webui-dropdownbutton"" role=""button""></div><div><img></div></div>")]
