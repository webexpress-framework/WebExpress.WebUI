...
{
    /// <summary>
    /// Tests the virtual list control.
    /// </summary>
    [Collection("NonParallelTests")]
    public class UnitTestControlVirtualList
    {
        /// <summary>
        /// Tests the id property of the virtual list control.
        /// </summary>
        [Theory]
        ...
        public void Id(string id, string expected)
        {
            ...
            var control = new ControlVirtualList(id)
            {
            };
        ...
        /// <summary>
        /// Tests the background color property of the virtual list control.
        /// </summary>
        [Theory]
        ...
        public void BackgroundColor(TypeColorBackground backgroundColor, string expected)
        {
            ...
            var context = UnitTestControlFixture.CreateRenderContextMock();
            var visualTree = new VisualTreeControl(componentHub, context.PageContext);
            var control = new ControlVirtualList()
            {
        ...
        /// <summary>
        /// Tests the layout property of the virtual list control.
        /// </summary>
        [Theory]
        ...
        /// <summary>
        /// Tests the add function of the virtual list control.
        /// </summary>
        [Theory]
        ...
        public void Add(IEnumerable<ControlListItem> items, string expected)
        {
            ...
            var context = UnitTestControlFixture.CreateRenderContextMock();
            var visualTree = new VisualTreeControl(componentHub, context.PageContext);
            var control = new ControlVirtualList(null);

            control.RetrieveVirtualItem += (s, e) => e.Items = items;
