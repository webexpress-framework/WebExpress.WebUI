...
namespace WebExpress.WebUI.Test.WebControl
{
    ...
    public class UnitTestControlCallout
    {
        /// <summary>
        ...
        public void Id(string id, string expected)
        {
            ...
            var control = new ControlCallout(id)
            {
            };
        ...
        public void Direction(TypeDirection direction, string expected)
        {
            ...
            var context = UnitTestControlFixture.CreateRenderContextMock();
            var visualTree = new VisualTreeControl(componentHub, context.PageContext);
            var control = new ControlCallout()
            {
        ...
        [InlineData(TypeTheme.Light, @"<div class=""wx-callout"" data-wx-theme=""light"">*</div>")]
        [InlineData(TypeTheme.Dark, @"<div class=""wx-callout"" data-wx-theme=""dark"">*</div>")]
